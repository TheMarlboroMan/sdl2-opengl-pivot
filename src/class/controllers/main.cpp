...
main_controller::main_controller(ldv::resource_manager& _v_manager, lda::resource_manager& _a_manager, lm::logger& _log, const ldtools::ttf_manager& f, dfw::audio& asys)
